...
public class MainActivity extends AppCompatActivity {
    ...
    public String[] evaluateGui() {
        ...
        CheckBox checkBoxQuestion4Hesse = findViewById(R.id.question_4_hesse);
        ...
        Boolean hesse = checkBoxQuestion4Hesse.isChecked();
        Boolean bavaria = checkBoxQuestion4Bavaria.isChecked();


        if (capital == false && hesse == false && bavaria == true) {
    ...
    public void reset(View view) {
        ...
        checkBox = findViewById(R.id.question_4_hesse);
        checkBox.setChecked(false);
